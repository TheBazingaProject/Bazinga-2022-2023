    ...
    public void loop() {
        switch (task) {
            ...
            case "pick up cone":
                ...
                //raise linear slide
                //move back
                task = "turn to face high junction";
                break;

            case "turn to face high junction":
                runtime.reset();
                //rotate around 90 degrees counterclockwise to face high junction
                task = "drive up to junction";
                break;

            case "drive up to junction":
                runtime.reset();
                //drive forward around 3 tiles to reach high junction
                task = "turn to high junction again";
                break;

            case "turn to high junction again":
                runtime.reset();
                //rotate around 90 degrees counterclockwise to face high junction directly
            ...
            case "move to park":
                runtime.reset();
                //if sheldon is blue, rotate around like 75 degrees and move to the bottom 2 tiles to park
                //if sheldon is green, rotate around like 45 degrees and move to the center 2 tiles to park
                //if sheldon is red, strafe a little to the right t not hit junction and move forward a tile to park
                task = "stop";
                break;
