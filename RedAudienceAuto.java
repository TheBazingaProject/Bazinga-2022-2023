    ...
    public void loop() {
        switch (task) {
            ...
            case "strafe to the right":
                ...
                movement.encoderStrafe(movement.TURN_SPEED,-12,12);
            ...
            case "deposit preload":
                ...
                //move forward above junction, around half a tile
            ...
            case "strafe to the left":
                runtime.reset();
                //strafe to the left around half a tile
                movement.encoderStrafe(movement.TURN_SPEED,12,-12);
                task = "align to stack";
                break;
            ...
            case "turn to face stack":
                runtime.reset();
                //turn around 90 degrees clockwise to face stack
                //movement.rotate(-90,movement.TURN_SPEED);
                task = "move to stack";
                break;

            case "move to stack":
                runtime.reset();
                //move forward around a tile to be in front of cone stack
                movement.encoderDrive(movement.DRIVE_SPEED,23,23);
                task = "pick up cone";
                break;
            ...
            case "move back":
                runtime.reset();
                //drive backwards around 2 tiles
                movement.encoderDrive(movement.DRIVE_SPEED,-46,-46);
                task = "turn to face junction";
                break;

            case "turn to face junction":
                runtime.reset();
                //turn to face the junction, 90 degrees counterclockwise
//                movement.rotate(90,movement.TURN_SPEED);

            case "strafe up to junction":
                runtime.reset();
                //strafe to the left around half a tile to reach high junction
                movement.encoderStrafe(movement.TURN_SPEED,12,-12);
            ...
            case "move to park":
                runtime.reset();
                /*
                if sheldon is blue, strafe around 2 and a half tiles to the right
                if sheldon is green, strafe around 1 and a half tiles to the right
                */
                //if not, then
                movement.encoderStrafe(movement.TURN_SPEED,-12,12);
                //afterwards, drive forward a tile
                movement.encoderDrive(movement.DRIVE_SPEED,23,23);
                task = "stop";
                break;
